...
Map SIRSS::take_step(Disease& disease) {
	analytics a;
	return take_step(disease, a);
}

Map SIRSS::take_step(Disease& disease, analytics& a) {
...
int SIRS::take_step_s(int i, int j, Disease& disease, Map& nextMap) {
...
int SIRS::take_step_i(int i, int j, Map& nextMap) {
